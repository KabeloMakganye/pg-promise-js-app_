...
<body>
  <div class="hello">
   <!-- <h1>{{ msg }}</h1>
    ...
    <button onClick="window.location.href='https://clock-system-6a6f8.web.app/#/status';">Update work status</button><label>BETA</label>&#128736;&#9888;<br><br>
...
table {
  ...
  border-spacing: 0;
  width: max-content;
  border: 1px solid rgb(247, 129, 129);
}
th, td {
  text-align: left;
  padding: 16px;
